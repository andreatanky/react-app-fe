...
export const MOCK_ACTIVE_PRODUCTS: Product[] = [
	...
	},
	{
		systemDocId: "prod-4",
		title:
			"Technology Advancements: Revolutionizing Communication Technology Advancements: Revolutionizing Communication Technology Advancements: Revolutionizing Communication",
		publishedDate: "2025-01-24",
		expiryDate: "2025-12-17",
		readProgress: 60,
		readingDuration: 5,
